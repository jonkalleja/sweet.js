...
//   if (from && to) {
//     if (to instanceof T.RawSyntax) {
//       return new T.RawSyntax({
//         value: to.value.setLineNumber(getLineNumber(from))
//       });
//     } else if (to instanceof T.RawDelimiter) {
//       return to.extend({
//         inner: List.of(to.inner.first())
//       })
//     }
...
const replace = (acc: { template: List<T.SyntaxTerm>, rep: List<T.Term> }, s: T.SyntaxTerm) => {
